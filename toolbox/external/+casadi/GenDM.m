classdef  GenDM < casadi.GenericMatrixCommon & casadi.SparsityInterfaceCommon
  ...
  methods
    ...
    %
    %
      out = casadiMEX(287, self, varargin{:});
      if nargout<=1
        varargout{1}=out;
      else
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(292, self, varargin{:});
    end
  ...
  methods(Static)
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(300, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(301, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(302, varargin{:});
    end
  end
end
